                ...
                <div class="panel panel-profile">
                    <div class="clearfix">
                        ...
                        <div class="profile-left">
                            ...
                            <div class="profile-header">
                                ...
                                <div class="profile-main">
                                    <img src="{{asset('/assets/img/user.png')}}" style="width: 100px;height:100px" class="img-circle" alt="Avatar">
                                    <h3 class="name">{{$user->nama}}</h3>
                                    <span class="online-status status-available">{{$user->level}}</span>
                                </div>
                        ...
                        <div class="profile-right">
                            <h4 class="heading">{{$user->nama}}'s Awards</h4>
                            <!-- AWARDS -->
                            <div class="awards">
                                <div class="row">
